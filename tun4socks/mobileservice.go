...
import (
	"chimney-go/lwip2socks/common/dns/cache"
	"chimney-go/lwip2socks/core"
	"chimney-go/lwip2socks/proxy/socks"
	"chimney-go/mobile"
	"chimney-go/privacy"
...
func startChimney(pw string, remoteHost string, port, UDPport int, pFun mobile.ProtectSocket) {
	...
	go func() {
		...
		remote := net.JoinHostPort(remoteHost, strconv.Itoa(UDPport))
